    ...
    if (clientID>-1)
        ...
        while (1)
            ...
            tic;
                ...
                v_0=zeros(4,2,4);
                t=1;
                [trgt_alg_x, trgt_alg_y]=OptimizeNextMove([main_trgt_pos(1) main_trgt_pos(2)], [1.41;1.41;1.41;1.41 ].*0.9, [0 2 2.828 2; 2 0 2 2.828; 2.828 2 0 2; 2 2.828 2 0].*0.9, v_0,x_0(:,1:2),t,1.0, 1.2);
...
function [Vx,Vy]=OptimizeNextMove(X,D,d,v_0,x_0,t,A,a)
    tfun = @(v)TargetFunction(v,X,D,d,x_0,t);
    [res, minval]=fmincon(tfun, v_0);
    Vx=res(:,1,:);
    Vy=res(:,2,:);
